...
//#include "../include/heightmap_core/Point3.h"
#include "oldmap_core/Point3.hpp"
...
namespace camel
{
    ...
    void Point3::SetNodeKeyXZ(const float x, const float z)
    {
		mNodeKey.SetX(x);
		mNodeKey.SetZ(z);
    }
	...
	float Point3::DistanceBetween2D(const Point2& other)
	{
